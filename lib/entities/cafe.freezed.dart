...
abstract class _Cafe extends Cafe {
  const factory _Cafe(
      ...
      @JsonKey(name: 'memo') required String memo,
      @JsonKey(name: 'img_path') required String imgPath,
      @JsonKey(name: 'tabelog_url') String? tabelogUrl}) = _$_Cafe;
