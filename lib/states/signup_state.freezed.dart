...
class _$SignupStateTearOff {
  ...
  SignupStateData call({String? email, String? password}) {
...
class _$SignupStateData implements SignupStateData {
  const _$SignupStateData({this.email, this.password});
  ...
  $SignupStateDataCopyWith<SignupStateData> get copyWith =>
      _$SignupStateDataCopyWithImpl<SignupStateData>(this, _$identity);
}

abstract class SignupStateData implements SignupState {
  const factory SignupStateData({String? email, String? password}) =
      _$SignupStateData;
